## combining monthly AIS data with flags id
...
in_dir <- c("/Users/bwhf/Documents/GitHub/political_connectivity/data/fh_month_flag/raw_data") # set input directory
...
# Replace NA in Flag to "UNK" (unknown)
drifting_longlines_1418$Flag[is.na(drifting_longlines_1418$Flag)] <- "unknown"

## check duplicates
# Identify duplicates, especially at 0, 180, and 360 degrees
duplicates <- drifting_longlines_1418 %>%
  group_by(Lat, Lon, Time_Range, Flag, Vessel_IDs, Apparent_Fishing_Hours) %>% # Adjust column names as needed
  filter(n() > 1) %>%
...
write_csv(unique_longlines, "/Users/bwhf/Documents/GitHub/political_connectivity/data/fh_month_flag/fh2014_2018_longlines_res01.csv")
